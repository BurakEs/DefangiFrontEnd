<template>
    <div id="defLogin">
        <img src="../assets/bg.png" style="width: 100%;height: 100vh; position:absolute;">
      <div class="defLog">
        <div class="container">
            <section id="formHolder">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 brand">
                        <a href="#" class="logo hidden-sm">DEFANGI</a>
                        ...
                        <div class="login form-peice ">
                            <form class="login-form" action="#">
                                <div class="form-group">
                                    <label :class="mail!=='' || activeClass==='email' ? 'active' : '' "
                                        for="loginemail">Email Adderss</label>
                                    <input @focus="activeClass= 'email' " @blur="activeClass = false" v-model="mail"
                                        type="email" name="loginemail" id="loginemail" required>
                                </div>

                                <div class="form-group">
                                    <label :class="pass!=='' || activeClass==='pass' ? 'active' : '' "
                                        for="loginPassword">Password</label>
                                    <input @focus="activeClass= 'pass' " @blur="activeClass = false" v-model="pass"
                                        type="password" name="loginPassword" id="loginPassword" required>
                                </div>
    ...
    export default {
        ...
        methods: {
            signIn() {
                ...
                /*Method içinde router */
                setTimeout(() => {this.$router.push({name:'Moon'})   }, 1500);
